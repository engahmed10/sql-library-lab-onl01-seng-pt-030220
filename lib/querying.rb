...
def select_series_title_with_most_human_characters
  ...
  INNER JOIN characters ON authors.id = characters.author_id  GROUP BY characters.species  ORDER BY count(characters.species) HAVING characters.species='human';"
end
