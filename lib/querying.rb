...
def select_series_title_with_most_human_characters
  "SELECT series.title FFROM series INNER JOIN authors ON series.author_id = authors.id
  INNER JOIN characters ON authors.id = characters.author_id GROUP BY series.title WHERE characters.species='human';"
end
